  ...
  return (
    <>
        <div className="homepage">
            ...
            <nav>
                <h1> <span style={{color:'#010822'}}>Evo_</span><span style={{color:'#fec887'}}>Sphere</span></h1>
            ...
            <div className="container">
                <div className="ylw_cnct">
                    <h1 data-aos="fade-up" >Connect with <span style={{color:'#ffbb6d '}}>Evo_Sphere</span> to connecting World </h1>
